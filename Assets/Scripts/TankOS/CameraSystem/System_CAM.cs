...
namespace Rover.Systems
{
    ...
    public class System_CAM : MonoBehaviour
    {
        ...
        void OnCam2ButtonPressed(InputAction.CallbackContext context)
        {
            SelectNewCameraMode(CameraMode.Cam2);
        }

        void OnCam3ButtonPressed(InputAction.CallbackContext context)
        {
            SelectNewCameraMode(CameraMode.Cam3);
        }

        void OnCam4ButtonPressed(InputAction.CallbackContext context)
        {
            SelectNewCameraMode(CameraMode.Cam4);
        }
