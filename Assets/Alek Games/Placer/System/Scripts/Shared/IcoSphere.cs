...
namespace AlekGames.Placer.Shared
{
    ...
    {
        // this function is copied and modifided from IcoSphereCreator by kaiware007 from gitHub. it has no licence, so i can take it
        // link: https://github.com/kaiware007/IcoSphereCreator
        public static Vector3[] getVertDir(int n) 
        {
            int nn = n * 4;
