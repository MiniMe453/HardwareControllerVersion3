...
namespace SCPE
{
    ...
    public sealed class Fog : PostProcessEffectSettings
    {
        ...
        private void Reset()
        {
            ...
            if (heightNoiseTex.value == null)
            {
                heightNoiseTex.overrideState = true;
                heightNoiseTex.value = UnityEditor.AssetDatabase.LoadAssetAtPath<Texture2D>(UnityEditor.AssetDatabase.GUIDToAssetPath("82a8d5f38e2ccf44c86362214b2d3e5e"));
            }
            #endif
        }
